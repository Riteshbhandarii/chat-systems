...
SECRET_KEY = "django-insecure-ydzs12v=qzdaurh0)%mu%$jz^z(ak_wv-f1c2gi=yl2xxonfqp"
...
# tells Django to use ASGI, to support using WebSockets (redis as a message broker)
ASGI_APPLICATION = "chat_project.asgi.application"

# storing and trasmiting data between websocket connection
CHANNEL_LAYERS = {
    "default":{             
        "BACKEND": "channels_redis.core.RedisChannelLayer", 
        "CONFIG": {
            "hosts":[('127.0.0.1',6379)], # server IP adress and 
        }
    },
}
